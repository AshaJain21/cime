#include "dtypes.h"
!===================================================
! DO NOT EDIT THIS FILE, it was generated using ../../src/externals/genf90/genf90.pl
...
# 10 "compare_vars_mod.F90.in"
  interface compute_var_stats
! TYPE real,double,int
     module procedure compute_var_stats_real
! TYPE real,double,int
     module procedure compute_var_stats_double
! TYPE real,double,int
     module procedure compute_var_stats_int
  end interface

# 15 "compare_vars_mod.F90.in"
  interface get_rdiff_stats
  ! TYPE real,double
     module procedure get_rdiff_stats_real
  ! TYPE real,double
     module procedure get_rdiff_stats_double
  end interface

# 20 "compare_vars_mod.F90.in"
contains

# 22 "compare_vars_mod.F90.in"
...
# 220 "compare_vars_mod.F90.in"
  end subroutine compare_one_var


  ! TYPE real,int,double
# 224 "compare_vars_mod.F90.in"
  subroutine compare_var_real(n,file, vid, idiff, ifilldiff, ifail, tindex)
    integer, intent(in) :: n
    type(file_t) :: file(2)
...
# 507 "compare_vars_mod.F90.in"
  end subroutine compare_var_real
  ! TYPE real,int,double
# 224 "compare_vars_mod.F90.in"
  subroutine compare_var_int(n,file, vid, idiff, ifilldiff, ifail, tindex)
    integer, intent(in) :: n
    type(file_t) :: file(2)
    integer, intent(in) :: vid(2)
    integer, intent(out) :: idiff      ! 1 if diffs in field, 0 otherwise (0 if only diffs are in fill pattern)
...
# 507 "compare_vars_mod.F90.in"
  ...
  ! TYPE real,int,double
# 224 "compare_vars_mod.F90.in"
  subroutine compare_var_double(n,file, vid, idiff, ifilldiff, ifail, tindex)
    integer, intent(in) :: n
    type(file_t) :: file(2)
    integer, intent(in) :: vid(2)
    integer, intent(out) :: idiff      ! 1 if diffs in field, 0 otherwise (0 if only diffs are in fill pattern)
...
# 507 "compare_vars_mod.F90.in"
  ...
  ! TYPE real,double
# 510 "compare_vars_mod.F90.in"
  subroutine get_rdiff_stats_real (s1, v1, v2, vdiff, mask, rdsum, rdlogsum, rdmax, loc)
    integer, intent(in) :: s1
    real(r4), intent(in) :: v1(:), v2(:), vdiff(:)
...
# 536 "compare_vars_mod.F90.in"
  end subroutine get_rdiff_stats_real
  ! TYPE real,double
# 510 "compare_vars_mod.F90.in"
  subroutine get_rdiff_stats_double (s1, v1, v2, vdiff, mask, rdsum, rdlogsum, rdmax, loc)
    integer, intent(in) :: s1
    real(r8), intent(in) :: v1(:), v2(:), vdiff(:)
    logical, intent(in) :: mask(:)
    real(r8), intent(out) :: rdsum, rdlogsum, rdmax
    integer, intent(out) :: loc
    real(r8) :: denom, rdiff(s1)
...
# 536 "compare_vars_mod.F90.in"
  end subroutine get_rdiff_stats_double

  ! TYPE real,int,double
# 539 "compare_vars_mod.F90.in"
  subroutine compute_var_stats_real (buf, nvalid, mask, min_loc, max_loc, min_val, max_val, avgval)
...
# 566 "compare_vars_mod.F90.in"
  end subroutine compute_var_stats_real
  ! TYPE real,int,double
# 539 "compare_vars_mod.F90.in"
  subroutine compute_var_stats_int (buf, nvalid, mask, min_loc, max_loc, min_val, max_val, avgval)
    integer(i4), intent(in) :: buf(:)
    logical, intent(in) :: mask(:)
    integer, intent(out) :: nvalid, min_loc, max_loc
    real(r8), intent(out) :: min_val, max_val, avgval
...
# 566 "compare_vars_mod.F90.in"
  end subroutine compute_var_stats_int
  ! TYPE real,int,double
# 539 "compare_vars_mod.F90.in"
  subroutine compute_var_stats_double (buf, nvalid, mask, min_loc, max_loc, min_val, max_val, avgval)
...
# 566 "compare_vars_mod.F90.in"
  end subroutine compute_var_stats_double





# 572 "compare_vars_mod.F90.in"
